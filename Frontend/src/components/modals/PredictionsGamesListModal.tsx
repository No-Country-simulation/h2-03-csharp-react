...
import GamesSearchBar from "../layout/Games/GamesSearchBar";
import { useGameContext } from "../../hooks/useGameContext";
import dates from "../../utils/predictions-tab-dates";

interface PredictionsGamesListModalProps {
  open: boolean;
  handleClose: () => void;
}

const PredictionsGamesListModal: React.FC<PredictionsGamesListModalProps> = ({
  open,
  handleClose,
}) => {
      ...
      >
        <Stack sx={{ flexWrap: "wrap", px: 3, color: "white" }}>
          ...
          <Typography variant="h5" align="center">
            {dateValue && `Elige un partido de ${dates.dateFormat(dateValue)}`}
          </Typography>
              ...
              >
                ...
                >
                  ...
                  <Grid2 size={2} justifyContent="center">
                    <Typography color="primary" align="center">VS.</Typography>
                  </Grid2>
                  <Grid2 size={5} justifyContent="flex-start" container gap={1}>
                    <img
...
export default PredictionsGamesListModal;
